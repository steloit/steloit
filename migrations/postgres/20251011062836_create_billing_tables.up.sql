...
CREATE TABLE IF NOT EXISTS usage_records (
    ...
    discounts NUMERIC(12, 6) NOT NULL DEFAULT 0.0,
    net_cost NUMERIC(12, 6) NOT NULL DEFAULT 0.0,
...
CREATE TABLE IF NOT EXISTS usage_quotas (
    ...
    monthly_cost_limit NUMERIC(12, 6) NOT NULL DEFAULT 0.0,
    current_requests BIGINT NOT NULL DEFAULT 0,
    current_tokens BIGINT NOT NULL DEFAULT 0,
    current_cost NUMERIC(12, 6) NOT NULL DEFAULT 0.0,
    currency VARCHAR(3) NOT NULL DEFAULT 'USD',
...
CREATE TABLE IF NOT EXISTS discount_rules (
    ...
    minimum_amount NUMERIC(12, 6) NOT NULL DEFAULT 0.0,
    maximum_discount NUMERIC(12, 6) NOT NULL DEFAULT 0.0,
...
CREATE TABLE IF NOT EXISTS invoices (
    ...
    subtotal NUMERIC(12, 6) NOT NULL DEFAULT 0.0,
    tax_amount NUMERIC(12, 6) NOT NULL DEFAULT 0.0,
    discount_amount NUMERIC(12, 6) NOT NULL DEFAULT 0.0,
    total_amount NUMERIC(12, 6) NOT NULL DEFAULT 0.0,
    currency VARCHAR(3) NOT NULL DEFAULT 'USD',
...
CREATE TABLE IF NOT EXISTS invoice_line_items (
    ...
    quantity NUMERIC(12, 6) NOT NULL DEFAULT 1.0,
    unit_price NUMERIC(12, 6) NOT NULL DEFAULT 0.0,
    amount NUMERIC(12, 6) NOT NULL DEFAULT 0.0,
    provider_id UUID,
    provider_name VARCHAR(255),
    model_id UUID,
    model_name VARCHAR(255),
